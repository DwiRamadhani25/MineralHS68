        ...
        <div class="col-12">
            <div class="card-box">
                <div class="d-flex align-items center justify-content-end mb-5">
                    <a href="{{ url('admin/pegawai/add') }}" class="btn btn-success">Tambah data</a>
                </div>
                <table class="table">
                    <thead>
                        <tr>
                    ...
                    <tbody>
                        @foreach ($list as $pegawai)
                            <tr>
                                ...
                                <td>
                                    <center>{{ $pegawai->tlp }}</center>
                                </td>
                                <td>
                                    <center>{{ $pegawai->alamat }}</center>
                                </td>
                                <td>
                                ...
                                <td>
                                    <center>
                                        <div class="btn-group">
                                            <a href="#detail{{ $pegawai->id }}" data-toggle="modal"
                                                class="btn btn-warning">Detail</a>
                                            <a href="{{ url('admin/pegawai/edit', $pegawai->id) }}"
                                                class="btn btn-primary">Edit</a>
												<a href="#hapus{{ $pegawai->id }}" data-toggle="modal"
                            ...
                            {{-- Ini modal hapus --}}
                            <div class="modal fade" id="hapus{{ $pegawai->id }}" tabindex="-1" aria-labelledby="exampleModalLabel"
                                aria-hidden="true">
                                <div class="modal-dialog modal-dialog-centered">
                                    <form action="{{ url('admin/pegawai/hapus', $pegawai->id) }}" method="post">
										@csrf
                            ...
                            {{-- Akhir modal hapus  --}}
                            {{-- Ini modal detail --}}
                            <div class="modal fade" id="detail{{ $pegawai->id }}" tabindex="-1" aria-labelledby="exampleModalLabel"
                                aria-hidden="true">
											...
											<ul class="list-detail">
												<li class="d-flex align-items-center justify-content-center mb-5">
													<span colspan="5" rowspan="2">
														<img src="{{ url('public') }}/{{ $pegawai->foto }}" alt="" style="width: 200px;height: 250px">
													</span>
												</li>
												<li>
													<span class="title">Nama</span>
													<span class="subtitle">{{ $pegawai->nama }}</span>
												</li>
												<li>
													<span class="title">Telpon</span>
													<span class="subtitle">{{ $pegawai->tlp }}</span>
												</li>
												<li>
													<span class="title">Email</span>
													<span class="subtitle">{{ $pegawai->email }}</span>
												</li>
												<li class="li-pass">
													<span class="title">Alamat</span>
													<span class="subtitle">{{ $pegawai->alamat }}</span>
												</li>
												
												<li class="li-pass">
													<span class="title">Password</span>
													<span class="subtitle">{{ $pegawai->password }}</span>
												</li>
											</table>
